...
export const PatientAnalysis = ({patientAnalysis} : { patientAnalysis: any}) => {
          ...
          <div className=" flex justify-between w-full ">
            <div className="flex flex-row gap-x-7 justify-center items-center ">
              ...
              <span className="text-slate-500  flex flex-row">
                DOB:<p className="ml-2 text-black"> {patientAnalysis.data.member.dob}</p>
              </span>
              <span className="text-slate-500 flex flex-row">
                Age:<p className="ml-2 text-black">{patientAnalysis.data.member.age}</p>
              </span>
              <span className="text-slate-500 mr-2 flex flex-row">
                Tel: <p className="ml-2 text-black">{patientAnalysis.data.member.phone_number}</p>
              </span>
  
              <span className="text-slate-500 mr-2 flex flex-row">
                Sex: <p className="ml-2 text-black">{patientAnalysis.data.member.gender}</p>
              </span>
          ...
          <div className="flex mt-5 gap-x-4">
            <div className="flex flex-col gap-y-5 justify-between max-w-[30%]">
              <div className="bg-white p-5 rounded-sm border shadow-xs h-full">
                ...
                {patientAnalysis.data.medical_history[0].answers.map((qa: any, index: Key) => {
                  return (
              ...
              <div className="flex flex-col bg-white border rounded-sm p-3">
                <Tabs defaultValue="analysis">
                  <TabsList className="gap-x-2">
                    ...
                    <TabsTrigger onClick={() => setDrawPolygon(true)} value="polygon" className="bg-[#E3E3E3]">
                      Draw polygon
                    </TabsTrigger>
                  </TabsList>
                </Tabs>
                ...
                <div className="flex">
                  <div className="flex flex-col w-[50%]">
                    <div className="flex flex-col items-end">
                        <Canvas imageUrl='./sampleImage.jpg' drawPolygon={drawPolygon} onSave={onSave}/>
                    </div>
