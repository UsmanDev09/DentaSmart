...
const DiagnosisDialog = DialogPrimitive.Root;

const DiagnosisDialogTrigger = DialogPrimitive.Trigger;

const DiagnosisDialogPortal = DialogPrimitive.Portal;

const DiagnosisDialogClose = DialogPrimitive.Close;
